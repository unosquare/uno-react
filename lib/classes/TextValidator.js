...
function (_ValidatorComponent) {
  ...
  function TextValidator() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(TextValidator).apply(this, arguments));
  }
  ...
  _createClass(TextValidator, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          rest = _objectWithoutProperties(_this$props, ["error", "errorMessages", "validators", "requiredError", "helperText", "validatorListener", "withRequiredValidator"]);

      var isValid = this.state.isValid;
      return React.createElement(_TextField.default, _extends({}, rest, {
        error: !isValid || error,
