...
var useStyles = (0, _makeStyles.default)(function (theme) {
  return {
    ...
    error: {
      backgroundColor: theme.palette ? "".concat(theme.palette.error.main, " !important") : "".concat(_red.default[600], " !important"),
    ...
    info: {
      backgroundColor: theme.palette ? "".concat(theme.palette.primary.main, " !important") : "".concat(_blue.default[600], " !important"),
      display: 'flex !important'
    },
    success: {
